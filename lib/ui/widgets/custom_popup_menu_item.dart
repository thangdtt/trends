...
///
/// A [CustomPopupMenuEntry] may represent multiple values, for example a row with
...
abstract class CustomPopupMenuEntry<T> extends StatefulWidget {
  ...
  ///
  /// If the [CustomPopupMenuEntry] represents a single value, this should return true
...
class PopupMenuDivider extends CustomPopupMenuEntry<Null> {
